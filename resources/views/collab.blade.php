...
<body class="bg-about img-fluid about">
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			<ul class="navbar-nav ml-auto">
				...
				<li class="text-dark navbar-item">
					<a href="" class="nav-link text-dark active">Collab</a>
				</li>
			</ul>
		</div>	
	</nav>
	...
	<main class="mt-4 mb-5">
		<div class="container">
			<h1 class="helvetica-n text-center text-white display-3 about-title">collab.</h1>
			<p class="lead text-center text-white mt-4 about">
				If you have any suggestions on how to make Bops FM better or would like to contribute 👨‍💻 to the project send me an email 📧: <span class="ps"> chukwudioranu@ymail.com </span> or holla on Twitter: <a href="https://twitter.com/chudioranu"><span class="ps">@chudioranu</span></a>
			</p>
		</div>
	</main>
